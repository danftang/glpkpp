...
//    std::vector<double> rCost;    // reduced cost
    ...
    void pivot(int i, int j, const SparseVec &pivotCol, bool leavingVarToUpperBound);
...
protected:
    ...
    void updateBetaAndLPSolution(int i, bool leavingVarToUpperBound, int j, const SparseVec &pivotCol);
    void updateBetaAndLPSolution(int i, bool leavingVarToUpperBound, int j, const std::vector<double> &pivotCol);
};
